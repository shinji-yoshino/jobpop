...
class ContactsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'kana' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'tel' => ['type' => 'string', 'length' => 11, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-10-28 07:55:28',
                'modified' => '2020-10-28 07:55:28',
            ],
        ];
        parent::init();
    }
